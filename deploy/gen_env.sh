...
llm_baichuan_endpoint="${unique_tag}-llm-baichuan-endpoint"
...
echo "llm_baichuan_endpoint=${llm_baichuan_endpoint}" >> .env
echo "llm_baichuan_stream_endpoint=${llm_baichuan_stream_endpoint}" >> .env
