...
class BufferCross():
    def __init__(self, gpu_id, model_location) -> None:
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.model_location, use_fast=False)
    ...
    def _model(self, gpu_id):
        ...
        if gpu_id == '-1':
            ...
            self.devices = []
            model = AutoModel.from_pretrained(self.model_location, trust_remote_code=True).half()
    ...
    def infer(self, queries, docs):
        ...
        result = {"scores": model_output.cpu().numpy().tolist(), "success": True}
        return result
...
if __name__ == "__main__":
    ...
    cross_model = BufferCross(gpu_id="0", model_location=model_location)
