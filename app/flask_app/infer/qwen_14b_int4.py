...
class Qwen14BInt4():
    ...
    def _model(self, gpu_id):
        ...
        if gpu_id == '-1':
            ...
            model = AutoModelForCausalLM.from_pretrained(self.model_location, device_map="auto", trust_remote_code=True).eval()
            model.generation_config  = GenerationConfig.from_pretrained(self.model_location, trust_remote_code=True) # 可指定不同的生成长度、top_p等相关超参
...
if __name__ == "__main__":
    ...
    bot = Qwen14BInt4(gpu_id="0", model_location=model_location)
